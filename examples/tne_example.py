...
sys.path.append(os.path.realpath( os.path.join(os.path.dirname(__file__), '..', 'edge_prediction', 'TNE')))
sys.path.append(os.path.realpath(os.path.join(os.path.dirname(__file__), '..', 'edge_prediction', 'TNE', 'utils')))

from os.path import basename, splitext, join
from edge_prediction.TNE.settings import *
...
params['number_of_communities'] = 2
# Parameters for LDA
